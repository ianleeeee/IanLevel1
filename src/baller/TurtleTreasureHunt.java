	...
	private void spaceBarWasPressed() {
		...
		if (tortoiseLocationX == 510 && tortoiseLocationY == 300) {
			JOptionPane
					.showMessageDialog(
							null,
							"Go to the skull's nose hole and there will be a sword and a message. It will tell you what to do next.");
		...
		if (tortoiseLocationX == 180 && tortoiseLocationY == 90) {
			JOptionPane
					.showMessageDialog(
							null,
							"You have found the sword. This sword has the power to kill the pirate! Go to the skull on the pirate's hat to battle him.");

		}
		if (tortoiseLocationX==400 && tortoiseLocationY==240) {JOptionPane.showInputDialog("AARRRRGGGGHHH!! Why are you here? ");
	...
	private void go() {
		...
		JOptionPane
				.showMessageDialog(null,
						"Ask the little girl for help with your quest. Go to the flower in her hair. Press the space bar to ask.");
	}
